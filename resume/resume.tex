...
\item 
    ...
    \begin{itemize}
        \resitem{Manager: Album packaging, distribution, and light marketing for various artists}
...
\item[Arts:] Music, Drawing, Curling
\item[Membership:] IEEE, ISCA (isca-speech.org)
\end{description}
